...
```{r}
trolleyStops <- st_read("https://seshat.datasd.org/sde/transit_stops_gtfs/transit_stops_datasd.geojson")
glimpse(trolleyStops)

trolleyStops <- 
  rbind(
    st_read("https://seshat.datasd.org/sde/transit_stops_gtfs/transit_stops_datasd.geojson") %>% 
      mutate(Line = "El") %>%
